...
@Configuration
@EnableWebSecurity //para dizer que irei personalizar as configurações de segurança
public class SecurityConfigurations {
    ...
    //Serve para exportar uma classe para o spring, fazendo com que ele consiga carrega-la
